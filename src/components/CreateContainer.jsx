  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      <div className="w-[90%] md:w-[50%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
        ...
        <div
          className="group flex justify-cente items-center flex-col
        border-2 border-dotted border-gray-300 w-full h-225 md:h-420
        cursor-pointer roun></Leadinged-lg"
        >
          {isLoading ? <Leading /> : <></>}
          {imageAsset ? (
            <>
              ...
              >
                ...
                >
                  <MdCloudUpload className="ext-gray-500 text-3xl hover:text-gray-700" />
