...
const CartContainer = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 right-0 w-full md:w-375 bg-white drop-shadow-md flex flex-col z-[101]"
    >
        ...
        <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
          ...
          {cartItems && cartItems.length > 0 ? (
            ...
            <div className="w-full h-full flex flex-col items-center justify-center gap-6">
              <img />
              <p className="text-sl text-textColor font-semibold">
                Add some item to your card
              </p>
            </div>
          )}
        </div>
